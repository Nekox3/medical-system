            ...
            $(document).ready(function() {
              $('#calendar').fullCalendar({
               ...
               $('#loading').toggle(bool);
                ...
                events:'<?php echo site_url('Vista_Estan/eventos'); ?>',

               dayClick:  function(){
                 // var moment = $('#calendar').fullCalendar('getDate');
                  //alert("Capturo la hora papuh " + moment.format());
               location.href ="http://localhost/Medical_System_Prueba/Vista_RegistroCit";
                },
                eventClick: function(){
                location.href ="http://localhost/Medical_System_Prueba/Vista_RegistroCit/Ver_tablaCita";
                },
...
<script src="assets1/plugins/justified-gallery/jquery.justifiedGallery.min.js"></script>
<script src="assets1/plugins/tinymce/tinymce.min.js"></script>
<script src="assets1/plugins/tinymce/jquery.tinymce.min.js"></script>-->
<script>
