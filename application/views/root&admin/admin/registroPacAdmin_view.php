  ...
  <form class="alert btn-theme03 top-center" action="<?php echo base_url()?>vista_RegistroPac/insercionPacienteAdmin" method="POST">
    <div class="row">
      <div class="border-head">
...
<div class="row">
 ...
 <div class="col-md-2">
    ...
    <input type="submit" class="btn btn-theme02" name="btnGuardar" value="Guardar" />
     ...
     <div align="center">  <h3><a  class="btn btn-info " href="<?php echo base_url();?>Vista_RegistroPac/Ver_tablaPacAdmin"> Registro de paciente  </a> </h3> </div> 
    <!--main content end-->
    <!--footer start-->
