...
<div class="row">
  ...
  <div class="col-md-2">
      Archivo
    <br>
    <input type="text" class="form form-control" name="archivo" placeholder="archivo" required >
    <br>
  ...
  <div class="col-md-2">
      Hora
    <br>
    <input type="time" class="form form-control"   name="hora"  max="24:59" min="00:00" required>
    <br>
